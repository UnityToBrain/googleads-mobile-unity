...
namespace GoogleMobileAds.Ump.Android
{
    ...
    {
        private Action<AndroidJavaObject> onConsentFormLoadSuccessAction;
        ...
        {
            this.onConsentFormLoadSuccessAction = onConsentFormLoadSuccessAction;
        }
...
#region Callbacks from ConsentForm
        ...
        {
            if (onConsentFormLoadSuccessAction == null)
            {
                return;
            }

            // Pass the consent form to the success callback.
            onConsentFormLoadSuccessAction(consentFormJavaObject);
        }
