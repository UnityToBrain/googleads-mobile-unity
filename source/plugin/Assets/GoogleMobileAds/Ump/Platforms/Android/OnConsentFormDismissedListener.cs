...
namespace GoogleMobileAds.Ump.Android
{
    ...
    {
        private Action<FormError> onConsentFormDismissedAction;
        ...
        {
            this.onConsentFormDismissedAction = onConsentFormDismissedAction;
        }
        ...
        {
            if (onConsentFormDismissedAction == null)
            {
                return;
            }
            ...
            onConsentFormDismissedAction(args);
        }
