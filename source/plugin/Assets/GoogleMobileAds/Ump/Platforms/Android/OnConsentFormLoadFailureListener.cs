...
namespace GoogleMobileAds.Ump.Android
{
    ...
    {
        private Action<FormError> onConsentFormLoadFailureAction;
        ...
        {
            this.onConsentFormLoadFailureAction = onConsentFormLoadFailureAction;
        }
...
#region Callbacks from ConsentForm
        ...
        {
            if (onConsentFormLoadFailureAction == null)
            {
                return;
            }
            ...
            onConsentFormLoadFailureAction(args);
        }
