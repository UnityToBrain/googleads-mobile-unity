...
namespace GoogleMobileAds.Ump.Android
{
    ...
    {
        private Action<FormError> onConsentInfoUpdateFailureAction;
        ...
        {
            this.onConsentInfoUpdateFailureAction = onConsentInfoUpdateFailureAction;
        }
...
#region Callbacks from ConsentInformation
        ...
        {
            if (onConsentInfoUpdateFailureAction == null)
            {
                return;
            }
            ...
            onConsentInfoUpdateFailureAction(args);
        }
