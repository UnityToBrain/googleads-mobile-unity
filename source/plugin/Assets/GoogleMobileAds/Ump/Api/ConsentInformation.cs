...
namespace GoogleMobileAds.Ump.Api
{
    ...
    public class ConsentInformation
    {
        ...
        public static ConsentStatus ConsentStatus
        {
            get
            {
                return (ConsentStatus)GetClient().GetConsentStatus();
            }
        }
        ...
        {
            GetClient().RequestConsentInfoUpdate(request, onSuccess, onError);
        }
        ...
        {
            return GetClient().IsConsentFormAvailable();
        }
        ...
        private static IConsentInformationClient GetClient()
        {
            if (_client == null)
            {
